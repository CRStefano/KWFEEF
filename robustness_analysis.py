"""Robustezza della SST alla tolleranza + ricerca locale (hill-climbing) che
trova l'ottimo S-FEEF pi* senza enumerare tutte le 203 partizioni.
Risponde alle critiche: SST convenzionale (R3-2) e assenza di regola locale (R2-3b)."""
import numpy as np
...
def main():
    ...
    print("scritto robustness_results.txt")
