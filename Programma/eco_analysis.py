"""Analisi densita'-dipendenza + ambiente stocastico per l'estensione life-history.
Genera eco_results.txt: ESS via invasione (max R0, non N*) e bet-hedging."""
import numpy as np
